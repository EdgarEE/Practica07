...
public class ProcesamientoImagen {
    ...
    public BufferedImage suma(){
        ...
        for( int i = 0; i < minWidth(); i++ ){
            for( int j = 0; j < minHeight(); j++ ){
            	colorAux1=new Color(this.imageActual1.getRGB(i, j));
            	colorAux2=new Color(this.imageActual2.getRGB(i, j));
            ...
            resultado.setRGB(i, j, colorSRGB);
            }
    }
        return resultado;
  }
    
    public BufferedImage resta(){
    	BufferedImage resultado= new BufferedImage(minWidth(),minHeight(),this.imageActual1.getType());
    	Color colorAux1, colorAux2;
    	int rojo,verde,azul;
    	int  colorSRGB;
    ...
    public BufferedImage multiplica(){
    	BufferedImage resultado= new BufferedImage(minWidth(),minHeight(),this.imageActual1.getType());
    	Color colorAux1, colorAux2;
    	int rojo,verde,azul;
    	int colorSRGB;
    ...
    public BufferedImage combLineal(){
    	BufferedImage resultado= new BufferedImage(minWidth(),minHeight(),this.imageActual1.getType());
    	Color colorAux1, colorAux2;
    	int rojo,verde,azul;
    	int colorSRGB;
