	...
	public Principal() {
		...
		butSum.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				chunkobj.obtainChunk(ObjProcesamiento);
				Resultado newWindow = new Resultado();
				newWindow.setVisible(true);
				BufferedImage imagen=chunkobj.controlSuma(ObjProcesamiento);
		...
		btnRes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Resultado newWindow = new Resultado();
				newWindow.setVisible(true);
				BufferedImage imagen=chunkobj.controlResta(ObjProcesamiento);
				newWindow.labelFinal.setIcon(new ImageIcon(imagen.getScaledInstance(newWindow.labelFinal.getWidth(), newWindow.labelFinal.getHeight(), Image.SCALE_AREA_AVERAGING)));
		...
		btnMul.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Resultado newWindow = new Resultado();
				newWindow.setVisible(true);
				BufferedImage imagen=chunkobj.controlMultiplica(ObjProcesamiento);
				newWindow.labelFinal.setIcon(new ImageIcon(imagen.getScaledInstance(newWindow.labelFinal.getWidth(), newWindow.labelFinal.getHeight(), Image.SCALE_AREA_AVERAGING)));
		...
		btnComb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Resultado newWindow = new Resultado();
				newWindow.setVisible(true);
				BufferedImage imagen=chunkobj.controlCombLineal(ObjProcesamiento);
				newWindow.labelFinal.setIcon(new ImageIcon(imagen.getScaledInstance(newWindow.labelFinal.getWidth(), newWindow.labelFinal.getHeight(), Image.SCALE_AREA_AVERAGING)));
